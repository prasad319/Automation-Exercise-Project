...
public class AddToCartFromRecommendedItems {
 ...
 @Test
 	public void AddToCartFromRecommendedItem() {
	 	try {
			object.AddToCartFromRecommendedItems page = new object.AddToCartFromRecommendedItems(driver);
	 		page.ValidateRecommendedItemsVisible();
	 		page.ClickOnAddToCart();
	 		page.ClickOnViewCartOption();
	 		page.ValidateProductDisplayingInCart();
		} catch (Exception e) {
