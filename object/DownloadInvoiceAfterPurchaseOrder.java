...
public class DownloadInvoiceAfterPurchaseOrder {
 ...
 By downloadInvoiceBtn=By.xpath("//a[normalize-space()='Download Invoice']");
 ...
 public DownloadInvoiceAfterPurchaseOrder(WebDriver driver) {
	this.driver=driver; 
 }
 ...
 public void ClickOnDownloadInvoiceOption() {
	 try {
		 driver.findElement(downloadInvoiceBtn).click();
		 Thread.sleep(5000);
		 String expectedFilePath="D:\\Automation testing Class\\Eclipse_workspace\\Automation_Exercise\\src\\test\\java\\downloads";
		 File downloadedFile = new File(expectedFilePath);
		 if (downloadedFile.exists()) {
			 System.out.println("File downloaded successfully.");
			 long fileSize = FileUtils.sizeOf(downloadedFile);
			 System.out.println("File size:59 bytes " + fileSize); 
		} else {
