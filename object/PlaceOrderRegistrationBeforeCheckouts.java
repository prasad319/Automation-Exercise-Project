...
public class PlaceOrderRegistrationBeforeCheckouts {
 WebDriver driver;
 By homepage=By.xpath("//html");
 ...
 public PlaceOrderRegistrationBeforeCheckouts(WebDriver driver) {
	this.driver=driver; 
 }
 ...
 public void SignupAndCreateAccount(String email,String username,String name,String password,String fstname,String lstname,String compnyname,String add1,String add2,String state,String city,String zipcde,String mobno ) {
	 ...
	 String actualText = driver.findElement(username1).getAttribute("admin319");
	 String expectedText="admin319";
	 softAssert.assertEquals(actualText, expectedText,"Text is mismatched");
	 String actualText1 = driver.findElement(emailAddress).getAttribute("admin319@gmail.com");
 ...
 public void ValidateAccountCreatedVisible() {
	 String actualText = driver.findElement(accountCreated).getAttribute("ACCOUNT CREATED!");
	 String expectedText="ACCOUNT CREATED!";
	 softAssert.assertEquals(actualText, expectedText,"Text is mismatched");	
	 driver.findElement(continueBtn).click();
 }
 public void ValidateUsernameVisibility() {
	 String actualText = driver.findElement(username2).getAttribute("admin319");
	 String expectedText="admin319";
